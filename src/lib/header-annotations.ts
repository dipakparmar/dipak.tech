...
export const INFO_BY_HEADER: Record<string, AnnotationInfo> = {
  ...
  'return-path': {
    title: 'Return-Path',
    description: 'The envelope sender address used for bounce notifications.',
  ...
  'x-mailer': {
    title: 'X-Mailer',
    description: 'The email client or software used to compose the message.',
  ...
  'x-gm-message-state': {
    ...
    description: 'Internal Gmail message state tracking token.',
  ...
  'x-ms-exchange-organization-authsource': {
    ...
    description: 'The Exchange server that authenticated the sender.',
    why: 'Identifies which Microsoft Exchange server handled authentication. Useful for tracing within Exchange organizations.',
    howToRead: 'Shows the FQDN of the authenticating Exchange server.'
  },
  'x-microsoft-antispam': {
    title: 'X-Microsoft-Antispam',
    description: "Microsoft's spam filtering verdict and scoring details.",
  ...
  'list-id': {
    title: 'List-Id',
    description: 'Identifies the mailing list that distributed this message.',
  ...
  'x-spam-score': {
    title: 'X-Spam-Score',
    description: 'Numeric spam confidence score from the filtering system.',
  ...
  'x-virus-scanned': {
    ...
    description: 'Indicates the message was scanned by an antivirus system.',
  ...
  'x-priority': {
    title: 'X-Priority',
    description: 'The sender-declared priority level of the message.',
...
export function getCardAnnotation(cardKey: string): AnnotationInfo | undefined {
