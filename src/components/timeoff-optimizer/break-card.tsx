...
export function BreakCard({
  ...
  return (
    <Card
      size="sm"
      className="ring-primary/10 hover:ring-primary/30 transition-shadow"
    >
        ...
        <div className="flex items-start justify-between gap-3">
          <div>
            ...
            <p className="text-sm font-semibold">
              {fmtRange(br.startDate, br.endDate)}
            </p>
          </div>
            ...
            <DropdownMenu>
              ...
              <DropdownMenuContent align="end">
                <DropdownMenuItem asChild>
                  <a
                    href={googleCalendarUrl(br, titleTemplate, notesTemplate)}
                    target="_blank"
                ...
                <DropdownMenuItem asChild>
                  <a
                    href={outlookComUrl(br, titleTemplate, notesTemplate)}
                    target="_blank"
                    rel="noopener noreferrer"
                  >
                    Outlook.com
                ...
                <DropdownMenuItem asChild>
                  <a
                    href={office365Url(br, titleTemplate, notesTemplate)}
                    target="_blank"
                    rel="noopener noreferrer"
                  >
                    Office 365
        ...
        <div className="flex flex-wrap items-center gap-3 text-[11px] text-muted-foreground">
          ...
          {br.customDayCount > 0 && (
            <span className="inline-flex items-center gap-1">
              ...
              {br.customDayCount} company day
              {br.customDayCount === 1 ? '' : 's'}
            </span>
          )}
