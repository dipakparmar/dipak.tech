    ...
    <div className="space-y-6">
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            Generate a signed JWT for use as{' '}
            <code className="rounded bg-muted px-1 py-0.5 font-mono text-xs">
              client_secret
            </code>{' '}
            with Sign in with Apple. All signing happens client-side — your
        ...
        <CardContent className="space-y-6">
          ...
          {lifetimeExceedsMax && (
            <Alert variant="destructive">
              ...
              <AlertDescription>
                Token lifetime exceeds Apple&apos;s maximum of 180 days (
                {MAX_LIFETIME_SECONDS.toLocaleString()} seconds).
              </AlertDescription>
            </Alert>
          )}
          ...
          <Alert>
            ...
            <AlertDescription>
              This tool is for{' '}
              <strong>local/internal developer use only</strong>. Your private
              key is processed entirely in the browser and is never sent to any
              server.
            </AlertDescription>
          </Alert>
              ...
              <div className="flex items-start justify-between">
                <div>
                  ...
                  <CardDescription>
                    ...
                    in Sign in with Apple token requests
                  </CardDescription>
                </div>
              </div>
            </CardHeader>
