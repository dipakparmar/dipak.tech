...
export function NewStamp() {
  return (
    <span
      aria-label="New"
      className="relative inline-flex align-middle ml-2.5 sm:absolute sm:ml-0 sm:-top-2 sm:-left-9 -rotate-[30deg] origin-center pointer-events-none select-none z-10"
    >
      <span className="relative inline-flex items-center justify-center px-2.5 pt-0.5 pb-1.5 leading-none">
        ...
        <span className="new-stamp-breathe relative z-10 font-handwritten text-[16px] leading-none text-amber-700/90 dark:text-amber-300/90">
          new
        </span>
      </span>
    </span>
