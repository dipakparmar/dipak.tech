...
export function DomainBadge({ domain }: { domain: string }) {
  ...
  return (
    ...
    >
      <Badge variant="outline" className="cursor-pointer font-mono hover:bg-muted">{domain}</Badge>
    </a>
  )
}
...
export function IpBadge({ ip }: { ip: string }) {
  return (
    <a
      ...
      rel="noopener noreferrer"
    >
      <Badge variant="outline" className="cursor-pointer font-mono hover:bg-muted">{ip}</Badge>
    </a>
  )
}
