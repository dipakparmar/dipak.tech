...
export const DATA: DataI = {
  ...
  description:
    'DevSecOps Engineer with 6+ years of experience in Cloud Automation, Kubernetes, and Monitoring.',
  summary:
    'DevSecOps Engineer with **6+ years** of experience in **AWS**, **Docker**, and **Kubernetes**. Proven expertise in _automating release processes_ and implementing efficient CI/CD pipelines. Skilled in **scripting** and **cloud infrastructure optimization**. Currently working at [**Clariti Software**](https://www.claritisoftware.com/?utm_source=dipak.tech&utm_medium=website&utm_campaign=portfolio) and previously held roles at [**Adroit Technologies**](https://www.atws.ca/?utm_source=dipak.tech&utm_medium=website&utm_campaign=portfolio), including DevOps Architect and Engineer. In my free time, I contribute to open-source projects, demonstrating a commitment to continuous learning and community involvement.',
