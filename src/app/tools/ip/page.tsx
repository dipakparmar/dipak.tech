...
export const metadata = {
  ...
  description:
    'Look up IP addresses, ASNs, BGP prefixes, and network block details with geolocation, routing, and peer data.',
  openGraph: {
    title: 'IP & Network Intelligence',
    description:
      'IP, ASN, and BGP prefix lookup with network intelligence, geolocation, and routing data',
