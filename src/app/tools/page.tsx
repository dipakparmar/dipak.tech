...
const tools: Tool[] = [
  {
    title: 'Design Studio',
    description:
      'Design social posts, stories, carousels, and covers with templates, handwriting fonts, and hand-drawn shapes',
    path: 'studio',
    icon: Palette,
  ...
  },
  {
    ...
    description:
      'Search CT logs, decode certificates, generate CSRs and key pairs',
    path: 'certificates',
    icon: Shield,
    color: 'text-cyan-500',
  ...
  },
  {
    ...
    description:
      'Parse and analyze email headers, routing hops, and authentication',
  ...
  },
  {
    ...
    description:
      'Generate ES256-signed JWTs for Sign in with Apple authentication',
  ...
  },
  {
    ...
    description:
      'Browser-based music tools - 8D audio maker with Smart automation, and more on the way',
    path: 'music',
    icon: Music2,
    color: 'text-sky-500',
  ...
  },
  {
    ...
    description:
      'Maximize your PTO by stacking days off around weekends, holidays, and company days',
...
export default async function ToolsPage() {
  ...
  return (
    <>
      <JsonLd
        data={[personSchema, websiteSchema, toolsListSchema, toolsPageSchema]}
      />
          ...
          <BlurFade delay={BLUR_FADE_DELAY}>
            <div className="mb-12 text-center">
              ...
              <p className="mx-auto mt-3 max-w-2xl text-muted-foreground">
                A collection of useful developer tools. Client-side tools run
                entirely in your browser. Network lookups are proxied through
                our server — no data is stored.
              </p>
            </div>
          </BlurFade>
          ...
          <div className="mx-auto grid max-w-3xl grid-flow-row-dense grid-cols-1 gap-3 sm:grid-cols-2 lg:grid-cols-3">
            {tools.map((tool, index) => (
              <BlurFade
                ...
                className={tool.span === 2 ? 'sm:col-span-2 lg:col-span-2' : ''}
              >
                <ToolCard
