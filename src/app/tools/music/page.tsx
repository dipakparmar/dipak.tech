...
export const metadata = {
  ...
  openGraph: {
    ...
    description:
      'Browser-based music and audio tools - 8D maker, and more on the way',
    ...
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: 'Music & Audio Tools by Dipak Parmar'
      }
    ]
  },
  twitter: {
...
const tools: MusicTool[] = [
  {
    ...
    description:
      'Turn any song into immersive 8D audio with Smart auto-automation and a timeline editor',
    path: 'music/8d-audio',
    icon: Headphones,
    color: 'text-sky-500',
  ...
  },
  {
    title: 'Vocal Remover',
    description:
      'Remove vocals or split any song into vocals, drums, bass, and other stems to make karaoke, instrumentals, or acapellas in your browser',
          ...
          <BlurFade delay={BLUR_FADE_DELAY}>
            <div className="mb-12 text-center">
              ...
              <p className="mx-auto mt-3 max-w-2xl text-muted-foreground">
                A growing set of browser-based music tools. Everything runs
                client-side - your audio never leaves your device.
              </p>
            </div>
          </BlurFade>
            ...
            <div className="mx-auto mt-10 max-w-3xl">
              ...
              <div className="grid grid-cols-1 gap-3 sm:grid-cols-3">
                {comingSoon.map((tool) => (
                  ...
                  >
                    <div
                      className={`mb-3 flex h-10 w-10 items-center justify-center rounded-lg ${tool.iconBg}`}
                    >
