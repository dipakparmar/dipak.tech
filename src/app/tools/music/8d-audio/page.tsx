...
export const metadata = {
  ...
  openGraph: {
    ...
    description: "Turn any track into immersive 8D audio with a live visualizer, right in your browser",
    url: "https://tools.dipak.io/music/8d-audio",
    siteName: "tools.dipak.io",
    type: "website",
    images: [{ url: ogImageUrl, width: 1200, height: 630, alt: "8D Audio Converter" }],
  },
  twitter: {
        ...
        <div className="mx-auto max-w-6xl space-y-8 sm:space-y-14">
          <BlurFade delay={BLUR_FADE_DELAY}>
            ...
            <div className="mb-8 text-center">
              ...
              <h1 className="text-3xl font-bold tracking-tight sm:text-4xl">8D Audio Converter</h1>
              <p className="mx-auto mt-3 max-w-2xl text-muted-foreground">
                Turn any song into immersive 8D audio that spins around your head. Tweak the rotation,
                reverb, and bass live, watch it in the visualizer, then export a WAV. Everything runs
                client-side, your audio never leaves your browser.
              </p>
